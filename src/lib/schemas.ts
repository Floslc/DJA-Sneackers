...
export const pairSchema = z.object({
  ...
  purchase_date: z.string().optional().nullable().transform((v) => v || null),
  sale_date: z.string().optional().nullable().transform((v) => v || null),
  shipping_date: z.string().optional().nullable().transform((v) => v || null),
